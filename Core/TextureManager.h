...
public:
	...
	void CreateFromRawRGBA8Data(const void * data, int imageWidth, int imageHeight, bool sRGB);
...
namespace TextureManager
{
	...
	const ManagedTexture* LoadFromRawData(const std::wstring& fileName, int imageWidth, int imageHeight, const void* data, bool sRGB = false);
	...
	inline const ManagedTexture* LoadFromRawData(const std::string& fileName, int imageWidth, int imageHeight, const void* data, bool sRGB = false)
	{
		return LoadFromRawData(MakeWStr(fileName), imageWidth, imageHeight, data, sRGB);
	}
